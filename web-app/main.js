...
const update_grid = function () {
    ...
    score_element.innerText = `Score: ${score.score}`;
    const lines_cleared_element = document.getElementById("lines_cleared");
    lines_cleared_element.innerText = `Lines cleared: ${score.lines_cleared}`;
    const level_element = document.getElementById("level");
    level_element.innerText = `Level: ${Score.level(score)}`;
...
const timer_function = function () {
    ...
    let level = Score.level(game.score);
    update_grid();
